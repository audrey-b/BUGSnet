...
nma.model.old <- function(data,
  ...
  max.delta <- paste0(nma.prior(data_arm = data, data_contrast = NULL, outcome=outcome, scale=scale, N=N, sd=sd, time = time))
