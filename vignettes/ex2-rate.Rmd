...
``` {r}
rate.slr <- data.prep(raw.data = fatdiet,
                     varname.t = "Treatment",
                     varname.s = "Study",
                     N = "n")
```
...
```{r, results = "hide"}
network.char <- net.tab(data.nma = rate.slr,
                                outcome = "death",
                                N = "n",
                                type.outcome = "rate",
                                time = "py")
...
```{r}
fixed_effects_model <- nma.bugs(data.nma=rate.slr,
                                 outcome="death",
                                 N="n",
...
random_effects_model <- nma.bugs(data.nma=rate.slr,
                                 outcome="death",
                                 N="n",
                                 baseline.name="control",
                                 family="poisson",
...
fe_inconsistency_model <- nma.bugs(data.nma=rate.slr,
                                   outcome="death",
                                   N="n",
                                   baseline.name="control",
                                   family="poisson",
