...
```{r, include = FALSE}
path <- "Z:/ResearchDocuments/Research/BUGSnet/BUGSnet/"
sep <- "/"
...
fatdiet <- read_excel(paste0(path,"data",sep,"rate_example.xlsx"))
```
