...
Our network has 6 treatments and a high degree of connectedness.
...
random effects consistency model [@lu2006assessing]. If our inconsistency model shows a better fit than the consistency model, then it is likely that there is inconsistency in the network.
