...
diabetes <- read_excel(paste0(path,"data",sep,"rate2_example.xlsx"))
```
...
``` {r}
rate2.slr <- data.prep(raw.data = diabetes,
                     varname.t = "Treatment",
                     varname.s = "Study",
                     N = "n")
```
...
```{r, results = "hide"}
network.char <- net.tab(data.nma = rate2.slr,
                                outcome = "diabetes",
                                N = "n",
                                type.outcome = "rate2",
                                time = "followup")
...
data.plot(patients.data = rate2.slr$raw.data, 
...
random_effects_model <- nma.model(data.nma=rate2.slr,
                                 outcome="diabetes",
                                 N="n",
                                 reference="Diuretic",
                                 family="binomial",
...
re_inconsistency_model <- nma.model(data.nma=rate2.slr,
                                   outcome="diabetes",
                                   N="n",
                                   reference="Diuretic",
                                   family="binomial",
...
league.out <- nma.league(random_effects_results,  central.tdcy="median", layout="long")
