...
```
If you want to review or modify the BUGS code, you can review it by outputting `fixed_effects_model$model.str` and `random_effects_model$model.str`. 
...
fe_inconsistency_model <- nma.model(data.nma=dich.slr,
                     outcome="responders",
                     N="sampleSize",
                     reference="SK",
                     family="binomial",
